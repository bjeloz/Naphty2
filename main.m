...
if true
    ...
    smac_data.r_cell = 1.2*smac_data.rcut;  % cut-off distance of cell list
    smac_data.n_cut = 5;
    smac_data.phi_0 = [0; 0.99];  % we just need to write the vector angle values below pi/2
    smac_data.sigma_0 = [0.25; 0.2];
    smac_data.a = 15;
    smac_data.b = 30;
...
%     smac_data.rcut = 0.65;
%     smac_data.ncut = 5;
%     smac_data.phi0 = [0; 0.43];  % we just need to write the vector angle values below pi/2
%     smac_data.sigma0 = [0.15; 0.15];
%     smac_data.a = 15;
%     smac_data.b = 30;
