function [ neighborList ] = cellNeighbors( partIndex, particleList, cellNum )
    % Create neighbor list

    % partIndex = particle index
    % particleList = nuber

    partCellNr = particleList(partIndex);

    % change from 1D list to 3D list of particles labeled to a given cell
